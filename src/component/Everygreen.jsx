            ...
            <div className=' max-w-[1140px] px-3 mx-auto mt-11'>
                <div className=' lg:flex-row flex-col flex items-center justify-between'>
                    ...
                    <div className='w-full lg:w-6/12' data-aos="fade-left">
                        <h3 className='text-center lg:text-start font-normal lg:text-4xl md:text-3xl text-2xl text-[#222222] leading-[42.3px] ff_LibreCaslon'>Evergreen Landscapes is a full-service landscaping company servicing the <span className=' italic text-[#88C701]'>Chicago</span> land area.</h3>
